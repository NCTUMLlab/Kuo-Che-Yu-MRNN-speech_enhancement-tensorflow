...
%% Loading Data
% 
% all1_t = csvread(strcat(data, 'Test2/LSTM_d=1000_sp_77_prediction1.csv'));
% all2_t = csvread(strcat(data, 'Test2/LSTM_d=1000_sp_77_prediction2.csv'));

all1_t = csvread(strcat(data, 'Test2/MRNN_d=1000_K=2_sp_77_prediction1.csv'));
all2_t = csvread(strcat(data, 'Test2/MRNN_d=1000_K=2_sp_77_prediction2.csv'));


%% Slice

audpath = strcat(data, 'Test2/Target1/');
...
for idx=1:6
    ...
    audpath1 = strcat(strcat(data, 'Test2/Target1/Audio/'), strcat(int2str(idx), '/'));
    audpath2 = strcat(strcat(data, 'Test2/Target2/Audio/'), strcat(int2str(idx), '/'));
...
%%
% get mix_phase
audpath_pha = strcat(data, 'Test2/Mix/phase/');
audpath_mag = strcat(data, 'Test2/Mix/');
